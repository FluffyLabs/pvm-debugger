...
function App() {
  ...
  return (
    <>
      <Textarea placeholder="Paste initial registers as an array of numbers" value={registersInput}
                onChange={(e) => {
      ...
      <Textarea placeholder="Paste program as an array of numbers" value={programInput}
                onChange={(e) => {
                  console.log(e.target.value)
                  try {
      ...
      <pre>
        <code>
        Program preview: { JSON.stringify(programPreviewResult) }
        </code>
      </pre>

      <pre>
        <code>
        Program run result: { JSON.stringify(programRunResult) }
        </code>
      </pre>
    </>
  )
