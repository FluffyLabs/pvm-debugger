...
const instructionsWithOneImmediate: InstructionTuple[] = [[Instruction.ECALLI, "ecalli", 0]];
...
const instructionsWithOneOffset: InstructionTuple[] = [[Instruction.JUMP, "jump", 0]];
...
const instructionWithTwoRegistersAndTwoImmediates: InstructionTuple[] = [[Instruction.LOAD_IMM_JUMP_IND, "load_imm_jump_ind", 0]];
