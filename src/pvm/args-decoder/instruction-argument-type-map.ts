...
export const instructionArgumentTypeMap = new Array<ArgumentType>(HIGHEST_INSTRUCTION_NUMBER + 1);
...
instructionArgumentTypeMap[Instruction.STORE_IMM_U8] = ArgumentType.TWO_IMMEDIATE;
instructionArgumentTypeMap[Instruction.STORE_IMM_U16] = ArgumentType.TWO_IMMEDIATE;
instructionArgumentTypeMap[Instruction.STORE_IMM_U32] = ArgumentType.TWO_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.STORE_IMM_IND_U8] = ArgumentType.ONE_REGISTER_TWO_IMMEDIATE;
instructionArgumentTypeMap[Instruction.STORE_IMM_IND_U16] = ArgumentType.ONE_REGISTER_TWO_IMMEDIATE;
instructionArgumentTypeMap[Instruction.STORE_IMM_IND_U32] = ArgumentType.ONE_REGISTER_TWO_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.ADD_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.MUL_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.MUL_UPPER_S_S_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.MUL_UPPER_U_U_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.SHLO_L_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.SHLO_R_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.SHAR_R_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.NEG_ADD_IMM] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.SHLO_L_IMM_ALT] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.SHLO_R_IMM_ALT] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
instructionArgumentTypeMap[Instruction.SHAR_R_IMM_ALT] = ArgumentType.TWO_REGISTERS_ONE_IMMEDIATE;
...
instructionArgumentTypeMap[Instruction.LOAD_IMM_JUMP_IND] = ArgumentType.TWO_REGISTERS_TWO_IMMEDIATE;
