  ...
  return (
    <div data-testid="settings-auto-continue">
      ...
      <p className="text-xs text-muted-foreground mb-2">
        Controls how the debugger handles host calls during execution. Traces
        are loaded in the program loader, not here.
      </p>
        ...
        {AUTO_CONTINUE_OPTIONS.map((option) => (
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span
                data-testid={`auto-continue-hint-${option.id}`}
